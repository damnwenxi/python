...
for i in range(1,100):
    # print(url+str(i))
    vote = requests.post(url=vote_url, data={'id': vote_id}, timeout=1, headers=header_vote).text
    print(vote)
    ...
    #             'http':ip_list[i]
    #         }
    #         vote = requests.post(url=vote_url,data={'id':vote_id}, timeout=1, headers=header_vote, proxies=proxy).text
    #         print(vote)
    #         if vote['status']:
